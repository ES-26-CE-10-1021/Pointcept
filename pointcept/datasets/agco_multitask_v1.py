"""
AGCO bounding-box detection  and segmentation dataset (AgcoMultiTaskV1) for 3DETR.
    ...
    def __getitem__(self, idx):
        ...
        if point_cloud.shape[0] != self.num_points:
            if self.deterministic_debug:
                ...
                segment = point_cloud[choices]
            else:
                point_cloud, downsampling_mask = _random_sampling(point_cloud, self.num_points)
                segment = segment[~downsampling_mask]            
