...
class _BaseSynthDatasetGroundSeg(DefaultDataset):
    """
...
class LsLidarSynthDatasetGroundSeg(_BaseSynthDatasetGroundSeg):
    SENSOR = "lslidar"


@DATASETS.register_module()
class OusterSynthDatasetGroundSeg(_BaseSynthDatasetGroundSeg):
    SENSOR = "ouster"
