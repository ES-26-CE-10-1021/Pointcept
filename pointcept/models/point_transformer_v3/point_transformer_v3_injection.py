...
class Block(PointModule):
    def __init__(
        ...
        self.dino_projection = nn.Linear(dino_input_shape, out_features=channels, bias=False)
        ...
        if self.use_dino and not getattr(self, "disable_dino", False):
            ...
            if "dino_feat" in point:
                ...
                if torch.is_tensor(val):
                    dino_feat = val
                elif isinstance(val, Point) and "feat" in val:
                    dino_feat = val.feat
                elif isinstance(val, dict) and "feat" in val:
                    dino_feat = val["feat"]

            if dino_feat is not None:
                # optional: detach if Dino features are precomputed
                dino_feat = dino_feat.detach()
