"""
3DETR on AGCO — v4m3-0-3cls-ouster: PTv3, num_queries=32 (ouster).

Sparse end of the v4 query-density sweep on ouster. Functionally
equivalent to v3m2-0-3cls-ouster.
...
Usage:
    sh scripts/train.sh -d agco -c det-3detr-v4m3-0-3cls-agco-ouster -n v4m3_ouster -g 2
"""
