"""
3DETR on AGCO — v3m3-1-3cls-ouster: PTv3 + SUN-like loss, overfit (ouster).

Same architecture and criterion as v3m3-0-3cls-ouster; val and test point
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m3-1-3cls-agco-ouster -n v3m3_overfit_ouster -g 2
"""
