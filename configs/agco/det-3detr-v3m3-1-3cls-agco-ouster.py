"""
3DETR on AGCO — v3m3-1-3cls-agco-ouster: overfit variant of v3m3-0 (train split for val/test).
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m3-1-3cls-agco-ouster -n det-3detr-v3m3-1-3cls-agco-ouster -g 2
"""
