"""
3DETR on AGCO — v2m4-0-3cls-agco-rslidar: Utonia enc_finetune + FPS 2048 + Vanilla encoder + SUN-like loss.
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v2m4-0-3cls-agco-rslidar -n det-3detr-v2m4-0-3cls-agco-rslidar -g 2
"""
