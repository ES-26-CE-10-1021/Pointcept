"""
3DETR on AGCO — v2m4-0-3cls-rslidar: Utonia + FPS 2048 + SUN-like loss (rslidar).
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v2m4-0-3cls-agco-rslidar -n v2m4_rslidar -g 2
"""
