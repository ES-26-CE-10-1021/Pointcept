"""
3DETR on AGCO — v2m4-0-3cls-ouster-dino: Utonia (enc_finetune) + FPS 2048 + DINO fusion (ouster).

Architecture:
  PTv3m3PreEncoderWithDino (pretrained Utonia, enc_finetune, npoint=2048 FPS)
...
DINO features are gathered at the same FPS-selected center points the PTv3
backbone emits (shared fps_inds), and added to the encoder tokens inside
the encoder slot.
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v2m4-0-3cls-agco-ouster-dino -n v2m4_ouster_dino -g 2
"""
