"""
Smoke test variant of `det-3detr-v1m3-0-3cls-agco-color-ouster.py`.

Differs only by:
  - train/val/test all use split="train" (only static 2 has color available)
  - epoch=1, eval_epoch=1
"""
