"""
3DETR on AGCO — v3m4-0-3cls-color-ouster: PTv3 + FPS 2048 + Vanilla encoder + SUN-like loss + RGB (ouster).

Differs from `det-3detr-v3m4-0-3cls-agco-ouster.py` only by `use_color=True`
in train/val/test and `PTv3PreEncoder.in_channels=6` (xyz + rgb). Loads
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m4-0-3cls-agco-color-ouster -n v3m4_color_ouster -g 2
"""
