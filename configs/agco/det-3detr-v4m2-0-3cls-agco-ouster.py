"""
3DETR on AGCO — v4m2-0-3cls: Scene-scaled center prediction, normal
train/val/test splits, num_queries=384.
...
Usage:
    sh scripts/train.sh -d agco -c det-3detr-v4m2-0-3cls-agco-ouster -n v4m2 -g 2
"""
