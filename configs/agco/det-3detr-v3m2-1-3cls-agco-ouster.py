"""
3DETR on AGCO — v3m2-1-3cls-agco-ouster: overfit config mimicking v1m2-1 settings with PTv3 model architecture.
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m2-1-3cls-agco-ouster -n det-3detr-v3m2-1-3cls-agco-ouster -g 2
"""
