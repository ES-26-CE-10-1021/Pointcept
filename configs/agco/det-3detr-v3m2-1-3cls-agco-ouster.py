"""
3DETR on AGCO — v3m2-1-3cls-ouster: PTv3 + IdentityEncoder + AGCO knobs, overfit (ouster).

Same architecture and criterion as v3m2-0-3cls-ouster; val and test point
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m2-1-3cls-agco-ouster -n v3m2_overfit_ouster -g 2
"""
