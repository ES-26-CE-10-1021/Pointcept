"""
3DETR on AGCO — v3m4-0-3cls-ouster-dino_true_fps: PTv3 + FPS 2048 + DINO fusion (ouster).

Architecture:
  PTv3PreEncoderWithDinoTrueFps (grid_size=0.05, npoint=2048 FPS,
...
as v1m3-dino, contrast to v3m4-dino's voxel-pooled fusion.
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m4-0-3cls-agco-ouster-dino_true_fps -n v3m4_ouster_dino_true_fps -g 1
"""
...
model = dict(
    ...
    pre_encoder=dict(
        type="PTv3PreEncoderWithDinoTrueFps",
        grid_size=0.05,
        npoint=2048,
        in_channels=3,
