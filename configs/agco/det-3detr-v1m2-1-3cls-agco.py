"""
3DETR on AGCO — v1m2-1-3cls: PointNet++ + AGCO knobs, overfit (lslidar).

Same architecture, dataset, and criterion as v1m2-0-3cls-agco; val and
test point to split="train" for overfit-style diagnostics.
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v1m2-1-3cls-agco -n v1m2_overfit -g 2
"""
