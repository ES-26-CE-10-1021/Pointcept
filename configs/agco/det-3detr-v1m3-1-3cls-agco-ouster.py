"""
3DETR on AGCO — v1m3-1-3cls-ouster: overfit variant of v1m3-0 (train split for val/test).
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v1m3-1-3cls-agco-ouster -n v1m3_sunloss_ouster_overfit -g 2
"""
