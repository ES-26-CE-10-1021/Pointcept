...
# misc custom setting
batch_size = 4 #96  # bs: total bs in all gpus
num_worker = 40 #96
mix_prob = 0
clip_grad = 3.0
empty_cache = False
...
# dataset settings
transform = [
    dict(type="LimitMaxPoints", max_points=30000),
...
data = dict(
    train=dict(
        ...
        datasets=[
            ...
            dict(
                type="AgcoAllRealWML",
                split=["train", "val", "test"], # NOTE: This refers to the splits defined in the dataset config file, thus not necessarily the names of the folders as seen for Scannet and S3DIS
                data_root="data/agco_all_real_wml",
                transform=transform,
                test_mode=False,
                loop=1,
            ),
