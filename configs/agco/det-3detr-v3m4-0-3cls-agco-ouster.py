"""
3DETR on AGCO — v3m4-0-3cls-ouster: PTv3 + FPS 2048 + Vanilla encoder + SUN-like loss (ouster).
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m4-0-3cls-agco-ouster -n v3m4_ouster -g 2
"""
