"""
3DETR on AGCO — v5m1-0-3cls-ouster: Frozen Utonia + Identity encoder
("Frozen Utonia + minimal head", ouster).
...
features. Token budget is kept at FPS-2048 to match v2m4 for clean
comparison.
...
Utonia's pretrained features are to the AGCO detection task under the
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v5m1-0-3cls-agco-ouster -n v5m1_ouster -g 2
"""
