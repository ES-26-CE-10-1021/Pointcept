"""
3DETR on AGCO — v3m4-0-3cls-rslidar: PTv3 + FPS 2048 + Vanilla encoder + SUN-like loss (rslidar).
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m4-0-3cls-agco-rslidar -n v3m4_rslidar -g 2
"""
