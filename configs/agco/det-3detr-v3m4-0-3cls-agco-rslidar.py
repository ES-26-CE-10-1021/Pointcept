"""
3DETR on AGCO — v3m4-0-3cls-agco-rslidar: PTv3 + FPS 2048 + Vanilla encoder + SUN-like loss.

Design:
  - Mirrors scannet det-3detr-v3m1-1-scannet (PTv3 with FPS post-downsampling +
    VanillaTransformerEncoder3DETR) so the AGCO and ScanNet baselines share
    backbone architecture; only the dataset varies.
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m4-0-3cls-agco-rslidar -n det-3detr-v3m4-0-3cls-agco-rslidar -g 2
"""
