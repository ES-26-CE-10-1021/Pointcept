"""
3DETR on AGCO — v3m4-0-3cls-ouster-dino: PTv3 + FPS 2048 + DINO fusion (ouster).

Architecture:
  PTv3PreEncoderWithDino (grid_size=0.05, npoint=2048 FPS,
...
the encoder slot. Clean "v3m4 + DINO fusion" ablation over v3m4 baseline.
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m4-0-3cls-agco-ouster-dino -n v3m4_ouster_dino -g 2
"""
