"""
3DETR on AGCO — v2m3-0-3cls-ouster: Utonia + AGCO knobs + SUN-like loss (ouster).

v2m3 = v2m1 backbone + v1m2 AGCO scene-scale knobs (center_offset_normalized,
fixed_pc_dims, num_queries=32, max_num_obj=16) + v1m3 SUN-like criterion.
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v2m3-0-3cls-agco-ouster -n v2m3_ouster -g 2
"""
