"""
3DETR on AGCO — v1m3-1-3cls: SUN-like loss, overfit (lslidar).

Same architecture, dataset settings, and SUN-like criterion as
v1m3-0-3cls-agco; val and test point to split="train" for overfit-style
diagnostics.
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v1m3-1-3cls-agco -n v1m3_overfit -g 2
"""
