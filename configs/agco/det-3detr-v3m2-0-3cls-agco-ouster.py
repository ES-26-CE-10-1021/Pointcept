"""
3DETR on AGCO — v3m2-0-3cls-ouster: PTv3 + IdentityEncoder + AGCO knobs (ouster).
...
Usage:
  sh scripts/train.sh -d agco -c det-3detr-v3m2-0-3cls-agco-ouster -n v3m2_ouster -g 2
"""
