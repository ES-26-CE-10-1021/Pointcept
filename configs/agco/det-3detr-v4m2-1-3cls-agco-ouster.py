"""
3DETR on AGCO — v4m2-1-3cls-ouster: PTv3, num_queries=384, overfit (ouster).

Same architecture and criterion as v4m2-0-3cls-ouster (num_queries=384);
...
Architecture:
  ...
  num_queries=384, center_offset_normalized=True, max_num_obj=16.
...
Usage:
    sh scripts/train.sh -d agco -c det-3detr-v4m2-1-3cls-agco-ouster -n v4m2_overfit_ouster -g 2
"""
