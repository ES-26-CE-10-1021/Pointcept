"""
3DETR on AGCO — v4m2-1-3cls: Overfit variant with scene-scaled center
prediction, num_queries=384.
...
Diff vs configs/agco/det-3detr-v3m2-1-3cls-agco.py:
  ...
  - num_queries: 32 -> 384          (3× the indoor default; sweep point
        for how query density affects recall on AGCO scenes).
...
Usage:
    sh scripts/train.sh -d agco -c det-3detr-v4m2-1-3cls-agco-ouster -n v4m2_overfit -g 2
"""
