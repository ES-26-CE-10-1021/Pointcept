"""
3DETR on AGCO — v4m1-1-3cls: PTv3, num_queries=128, overfit (lslidar).

Same architecture and criterion as v4m1-0-3cls-agco (num_queries=128);
...
Usage:
    sh scripts/train.sh -d agco -c det-3detr-v4m1-1-3cls-agco -n v4m1_overfit -g 2
"""
