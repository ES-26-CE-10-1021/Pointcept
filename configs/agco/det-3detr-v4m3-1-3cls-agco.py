"""
3DETR on AGCO — v4m3-1-3cls: PTv3, num_queries=32, overfit (lslidar).

Same architecture and criterion as v4m3-0-3cls-agco (num_queries=32 —
the sparse end of the v4 query-density sweep); val and test point to
split="train" for overfit-style diagnostics. Functionally equivalent
to v3m2-1-3cls-agco.
...
Usage:
    sh scripts/train.sh -d agco -c det-3detr-v4m3-1-3cls-agco -n v4m3_overfit -g 2
"""
